...
@section('content')
{{-- Hidden Element --}}
<input type="hidden" id="check-store-url" value="{{ route('member.checkout.store') }}?course-id={{ $course->id }}&buy-now=true">
...
<div class="container">
	<div class="row mt-4">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
			...
			<div class="card card-custom mt-4" style="display: none;">
				<div class="card-body">
					<div class="form-group">
						<label for="">@lang('label.payment_method')</label>
