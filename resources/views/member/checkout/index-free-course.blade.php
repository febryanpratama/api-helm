...
<link rel="stylesheet" href="{{ asset('css/index-free-course.css') }}">
@endpush
...
<div class="container">
	<div class="row mt-4">
		<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
			<div class="clearfix bg-white card-detail">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
			<div class="card card-detail mt-4 custom-height-detail-order">
				...
				<div class="card card-detail mt-4 mb-4">
					<div class="card-body">
				...
				<div class="card card-detail mt-4" style="display: none;">
					<div class="card-body">
