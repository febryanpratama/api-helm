...
@section('content')
{{-- Hidden Element --}}
<input type="hidden" id="task-store-url" value="{{ route('task.store') }}">
<input type="hidden" id="major-id" value="{{ request('majorId') }}">
			...
			<div class="card-body">
	      		<div class="row">
	      			<div class="col-12 col-sm-12 col-md-12 col-xl-12">
	      				<div class="form-group">
	      				    ...
	      				    <input type="text" name="task" class="form-control" placeholder="@lang('label.enter_task_name')" value="" id="task_name" autofocus>
	      				</div>
	      			</div>
	      		</div>
				...
				<div class="row">
	      			<div class="col-12 col-sm-12 col-md-6 col-xl-6">
		                ...
		                <span id="span-name-file-task" class="pl-2"><i>*@lang('label.not_file_selected')</i></span>
		        ...
		        <div class="row">
		            <div class="col-12 col-sm-12 col-md-12 col-xl-12">
		              <div class="form-group">
		                ...
		                <textarea name="note" class="form-control tinymce-element" placeholder="@lang('label.enter_task_details')" id="note-detail-task" rows="3"></textarea>
		              </div>
		            </div>
		        </div>
...
<script>
	...
	$(document).on('submit', '#task-area form', function (e) {
	    ...
	    fd.append('major_id', $('#major-id').val())
